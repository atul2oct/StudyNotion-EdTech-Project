  ...
  return (
    <div className='bg-richblack-800'>
      ...
      <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
            ...
            <div className='flex flex-col gap-2 mt-2'>
              {
                Plans.map((element,index)=>{
                  return(
                    <div key={index} className='text-[14px] cursor-pointer hover:text-richblack-50 transition-all duration-20'>
                      <Link to={element.split(" ").join("-").toLowerCase()}>{element}</Link>
                    </div>
                  )
                })
        ...
        {/* section - 2 */}
        <div className='flex flex-wrap flex-row justify-between gap-3 pl-3 lg:pl-11 lg:w-[50%]'>
          {
      ...
      <div className='flex flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto pb-14 text-sm'>
        <div className='flex flex-col items-center justify-between gap-3 w-full lg:items-start lg:flex-row'>
          {/* section 1 */}
