...
const LearningGrid = () => {
  return (
    <div className='grid mx-auto lg:grid-cols-4 mb-10 lg:w-fit'>
        {
            LearningGridArray.map((card,index)=>{
                return(
                    <div className={`lg:h-[280px] p-5
                        ${index === 0 && "bg-richblack-900 lg:col-span-2"}
                        ${index % 2 === 1 ? "bg-richblack-700":"bg-richblack-800"}
