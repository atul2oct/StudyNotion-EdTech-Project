    ...
    <div className='mx-auto w-11/12 max-w-[1000px] py-10'>
...

        {
            ...
            ( 
                ...
                (
                    <div>                        
                        <div className='my-4 flex justify-between h-[450px] space-x-4'>
                                {/* Render chart / graph */}
                                {
                            ...
                            <div className='flex space-x-6 my-4'>
                                {
                                    courses.slice(0,3).map((course) => (
                                        <div key={course._id} className="w-1/3">
                                            <img src={course.thumbnail} alt='course thumbnail image' className="h-[201px] w-full rounded-md object-cover"/>
